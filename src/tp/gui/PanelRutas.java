...
public class PanelRutas extends PanelPersonalizado{
	...
	private JLabel titulo = new JLabel("AdministraciÛn de Rutas",SwingConstants.CENTER);
	...
	private JLabel texto_duracion = new JLabel("Duraci√≥n (min):",SwingConstants.RIGHT);
	private JTextField campo_duracion = new JTextField();
	
	private JLabel texto_peso_maximo = new JLabel("Peso m√°ximo (Kg):",SwingConstants.RIGHT);
	...
	private void intentarEliminar() {
		...
		if(row == -1)
			...
			int resultado = eliminarPopUp("¬øEliminar "+identificador+"?");
